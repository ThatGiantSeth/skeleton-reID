...
- [x] Write training and usage documentation
- [x] Create demo video
...
- [ ] ~~Fix GUI freezing on startup occasionally (likely due to initialization issue with camera)~~ - not possible within the scope of this project, requires editing OpenNI/NiTE itself
- [x] Compartmentalize client code so that OpenNI can be swapped out for a different architecture in the future
